...
#     def __init__(self, state_dim, hidden_dim, action_dim, layer_num=2):
...
class ValueNet(torch.nn.Module):
    def __init__(self, state_dim, hidden_dim, layer_num=2):
        super(ValueNet, self).__init__()
        for m in range(1, layer_num):
            setattr(self, f'fc{m+1}', torch.nn.Linear(hidden_dim, hidden_dim))
        self.fc1 = torch.nn.Linear(state_dim, hidden_dim)
